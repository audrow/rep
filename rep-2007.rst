...
.. code-block:: cpp
   ...
   // TODO note that we may need additional API to match the service type support to this custom type support
   // TODO Make this example use service
   using MyAdaptedRequestType = TypeAdapter<std::string, std_msgs::srv::String>;
   using MyAdaptedResponseType = TypeAdapter<bool, std_msgs::srv::Trigger::Response>;
   ...
   // TODO make a more complete example to show that the bool adapted type also works
